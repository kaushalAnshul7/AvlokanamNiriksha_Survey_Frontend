...
@Component({
  selector: 'app-createsurveyquestionuser',
  templateUrl: './createsurveyquestionuser.component.html',
  styleUrls: ['./createsurveyquestionuser.component.css']
})
export class CreatesurveyquestionuserComponent implements OnInit {
  id: string;
  reloadCurrentPage(){
